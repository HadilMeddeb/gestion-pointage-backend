		...
		<div className="right-sidebar-body customscroll">
			<div className="right-sidebar-body-content">
				...
				<div className="sidebar-btn-group pb-30 mb-10">
					<a href="#" className="btn btn-outline-primary header-white active">White</a>
					<a href="#" className="btn btn-outline-primary header-dark">Dark</a>
				</div>

				<h4 className="weight-600 font-18 pb-10">Sidebar Background</h4>
				<div className="sidebar-btn-group pb-30 mb-10">
					<a href="#" className="btn btn-outline-primary sidebar-light ">White</a>
					<a href="#" className="btn btn-outline-primary sidebar-dark active">Dark</a>
				</div>
